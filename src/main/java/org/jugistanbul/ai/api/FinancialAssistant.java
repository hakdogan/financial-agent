...
@SystemMessage("""
                ...
                You can use the available tools to find exchange rates and precious metal prices. 
                
                Your role is to:
                
                - Fetch & Share Data: Provide accurate prices for gold (XAU), silver (XAG), platinum (XPT), and palladium (XPD) per ounce/gram, or exchange rates for requested currencies.
